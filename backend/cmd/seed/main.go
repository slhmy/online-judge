...
var sampleContests = []SampleContest{
	{
		...
		Name:         "Introduction to Algorithms Contest",
		ShortName:    "INTRO2024",
		StartTime:    time.Now().Add(-24 * time.Hour),
		EndTime:      time.Now().Add(7 * 24 * time.Hour),
		ProblemIDs:   []string{"A", "B", "C", "I"},
		ProblemNames: []string{"A", "B", "C", "D"},
		Points:       []int32{100, 100, 100, 100},
	},
	{
		ExternalID:   "advanced-contest-2024",
		Name:         "Advanced Algorithms Contest",
		ShortName:    "ADV2024",
		StartTime:    time.Now().Add(-2 * time.Hour),
		EndTime:      time.Now().Add(5 * 24 * time.Hour),
		ProblemIDs:   []string{"D", "E", "H", "J"},
		ProblemNames: []string{"A", "B", "C", "D"},
		Points:       []int32{200, 200, 200, 200},
	},
	{
		ExternalID:   "challenge-contest-2024",
		Name:         "Algorithm Challenge Contest",
		ShortName:    "CHAL2024",
		StartTime:    time.Now().Add(1 * time.Hour),
		EndTime:      time.Now().Add(3 * 24 * time.Hour),
		ProblemIDs:   []string{"F", "G"},
		ProblemNames: []string{"A", "B"},
		Points:       []int32{300, 300},
	},
}
